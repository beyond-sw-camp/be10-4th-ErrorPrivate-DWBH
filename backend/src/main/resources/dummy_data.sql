...
INSERT INTO tb_counselor_hire_file (counselor_hire_seq, file_seq2)
VALUES
    (1, 1),
    (2, 2);

-- tb_counsel_offer_file 테이블 더미 데이터
INSERT INTO tb_counsel_offer_file (file_seq2, counsel_offer_seq)
VALUES
    (1, 1),
    (2, 2);

-- tb_user_profile_file 테이블 더미 데이터
INSERT INTO tb_user_profile_file (file_seq2, user_seq)
VALUES
    (1, 1),
    (2, 2);
